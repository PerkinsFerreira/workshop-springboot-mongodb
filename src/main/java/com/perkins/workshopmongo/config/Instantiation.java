package com.perkins.workshopmongo.config;
...
import com.perkins.workshopmongo.dto.AuthorDTO;
import com.perkins.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano!", sdf.parse("31/03/2018"), new AuthorDTO(alex));
		...
		//Salva as Referencias de Posts na Maria
